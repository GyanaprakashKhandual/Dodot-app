...
import { FaEye, FaEyeSlash, FaEnvelope, FaLock, FaUser, FaArrowLeft, FaExclamationTriangle, FaRocket, FaCheckCircle, FaBug, FaChartLine, FaProjectDiagram, FaComments, FaTasks } from 'react-icons/fa';
...
const AuthSystem = () => {
    ...
    return (
        <div className="min-h-screen flex bg-[radial-gradient(circle_at_top,_#22c55e,_#ffffff,_#e6ffe6)]">
                ...
                <div className="max-w-lg text-center">
                    ...
                    >
                        <h1 className="text-5xl font-bold text-gray-800 mb-6">
                            Welcome to <span className="text-blue-600">Curacore</span>
                        </h1>
                        <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                            Streamline your development process with our comprehensive <span className="font-semibold text-blue-600">bug tracking</span> solution that helps you
                            <span className="font-semibold text-green-600"> manage issues</span>,
                            <span className="font-semibold text-orange-600"> organize projects</span>, and
                            <span className="font-semibold text-purple-600"> collaborate effectively</span>.
                        </p>
                        <p className="text-lg text-gray-500 mb-12">
                            Track bugs, assign tasks, monitor progress, and facilitate communication between developers and testers.
                        </p>
                        {/* Feature Icons */}
                        <div className="flex justify-center space-x-8 mb-8">
                            ...
                            >
                                <FaBug className="text-3xl text-blue-600 mb-2" />
                            ...
                            <motion.div
                                ...
                                className="flex flex-col items-center p-4 bg-white rounded-lg shadow-md"
                            >
                                <FaComments className="text-3xl text-orange-600 mb-2" />
                            ...
                            <motion.div
                                ...
                                className="flex flex-col items-center p-4 bg-white rounded-lg shadow-md"
                            >
                                <FaTasks className="text-3xl text-purple-600 mb-2" />
